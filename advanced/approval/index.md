...
1. User approves B
1. User approves C
1. All three execute (in order or parallel depending on `parallel` config)

**With `executeOnApproval`: true:**

1. Model requests tools A, B, C
1. User approves A - A executes immediately
1. User approves B - B executes immediately
1. User approves C - C executes immediately
