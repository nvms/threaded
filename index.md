...
1. Compose workflow steps (model calls, scopes, conditions)
1. Execute and stream results

Next: [Quick Start](https://nvms.github.io/threaded-ai/quick-start/index.md)
