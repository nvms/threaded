...
The same message format works across OpenAI, Anthropic, and Google. See [Multimodal Input](https://nvms.github.io/threaded-ai/advanced/multimodal/index.md) for PDFs, audio, URLs, and the full capability matrix.
